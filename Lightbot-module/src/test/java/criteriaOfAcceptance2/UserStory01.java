...
public class UserStory01 {
	 ...
	 * un tamaño de 10 acciones, y las funciones con dos acciones cada una.
	 */
	@Test
	public void test02() throws IOException {
		this.gameGenerator = new GameGenerator(ConstantsTest.ROUTE_MAP_PROPERTIES, ConstantsTest.ROUTE_JSON_ACTIONS_3);
		assertEquals(10, this.gameGenerator.getInvokerCommands().size());
	 ...
	 * archivo. Se de contar con una acción, y dos listas de acciones que contenga
	 * dos acciones cada una, quedando con un total de 5 acciones.
	 */
	@Test
	public void test03() throws IOException {
		...
		assertEquals(5, this.gameGenerator.getInvokerCommands().size() + this.gameGenerator.getFunctions().get("fun").size());	
	}
}
